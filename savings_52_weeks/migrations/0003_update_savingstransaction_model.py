...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        # --- SAFE add for transaction_type (no-op if column already exists) ---
        migrations.RunSQL(
            sql="""
                ALTER TABLE savings_52_weeks_savingstransaction
                ADD COLUMN IF NOT EXISTS transaction_type varchar(20) NOT NULL DEFAULT 'deposit';
            """,
            reverse_sql="""
                ALTER TABLE savings_52_weeks_savingstransaction
        ...
        # Keep Django's state in sync with the DB (so future migrations see the field)
